...
% \begin{figure}
%     \includegraphics[width=.24\textwidth]{Images/data/Zeroth_case/1.png}\hfill
%     \includegraphics[width=.24\textwidth]{Images/data/Zeroth_case/2.png}\hfill
%     \includegraphics[width=.24\textwidth]{Images/data/Zeroth_case/3.png}\hfill
%     \includegraphics[width=.24\textwidth]{Images/data/Zeroth_case/4.png}
%     % \\[\smallskipamount]
% \end{figure}

% \begin{figure}
%     \includegraphics[width=.24\textwidth]{Images/data/First_case/1.png}\hfill
%     \includegraphics[width=.24\textwidth]{Images/data/First_case/2.png}\hfill
%     \includegraphics[width=.24\textwidth]{Images/data/First_case/3.png}\hfill
%     \includegraphics[width=.24\textwidth]{Images/data/First_case/4.png}
% \end{figure}
% \begin{figure}
%     \includegraphics[width=.24\textwidth]{Images/data/Second_case/1.png}\hfill
%     \includegraphics[width=.24\textwidth]{Images/data/Second_case/2.png}\hfill
%     \includegraphics[width=.24\textwidth]{Images/data/Second_case/3.png}\hfill
%     \includegraphics[width=.24\textwidth]{Images/data/Second_case/4.png}
% \end{figure}
% \begin{figure}  
%     \includegraphics[width=.24\textwidth]{Images/data/Third_case/1.png}\hfill
%     \includegraphics[width=.24\textwidth]{Images/data/Third_case/2.png}\hfill
%     \includegraphics[width=.24\textwidth]{Images/data/Third_case/3.png}\hfill
%     \includegraphics[width=.24\textwidth]{Images/data/Third_case/4.png}
% \end{figure}
% \begin{figure}
%     \includegraphics[width=.24\textwidth]{Images/data/Fourth_case/1.png}\hfill
%     \includegraphics[width=.24\textwidth]{Images/data/Fourth_case/2.png}\hfill
%     \includegraphics[width=.24\textwidth]{Images/data/Fourth_case/3.png}\hfill
%     \includegraphics[width=.24\textwidth]{Images/data/Fourth_case/4.png}
% \end{figure}

% \begin{figure}
%     \includegraphics[width=.24\textwidth]{Images/data/Fifth_case/1.png}\hfill
%     \includegraphics[width=.24\textwidth]{Images/data/Fifth_case/2.png}\hfill
%     \includegraphics[width=.24\textwidth]{Images/data/Fifth_case/3.png}\hfill
%     \includegraphics[width=.24\textwidth]{Images/data/Fifth_case/4.png}
%     \caption{Write caption explaining images}\label{fig:foobar}
% \end{figure}
...
% \begin{figure}
%     \includegraphics[width=.24\textwidth]{Images/simulation_no_obs/straight_paths/01.png}\hfill
%     \includegraphics[width=.24\textwidth]{Images/simulation_no_obs/straight_paths/02.png}\hfill
%     \includegraphics[width=.24\textwidth]{Images/simulation_no_obs/straight_paths/03.png}\hfill
%     \includegraphics[width=.24\textwidth]{Images/simulation_no_obs/straight_paths/04.png}
%     \\[\smallskipamount]
% \end{figure}

% \begin{figure}
%     \includegraphics[width=.24\textwidth]{Images/simulation_no_obs/straight_paths/11.png}\hfill
%     \includegraphics[width=.24\textwidth]{Images/simulation_no_obs/straight_paths/12.png}\hfill
%     \includegraphics[width=.24\textwidth]{Images/simulation_no_obs/straight_paths/13.png}\hfill
%     \includegraphics[width=.24\textwidth]{Images/simulation_no_obs/straight_paths/14.png}
% \end{figure}
% \begin{figure}
%     \includegraphics[width=.24\textwidth]{Images/simulation_no_obs/straight_paths/21.png}\hfill
%     \includegraphics[width=.24\textwidth]{Images/simulation_no_obs/straight_paths/22.png}\hfill
%     \includegraphics[width=.24\textwidth]{Images/simulation_no_obs/straight_paths/23.png}\hfill
%     \includegraphics[width=.24\textwidth]{Images/simulation_no_obs/straight_paths/24.png}
% \end{figure}
% \begin{figure}  
%     \includegraphics[width=.24\textwidth]{Images/simulation_no_obs/straight_paths/31.png}\hfill
%     \includegraphics[width=.24\textwidth]{Images/simulation_no_obs/straight_paths/32.png}\hfill
%     \includegraphics[width=.24\textwidth]{Images/simulation_no_obs/straight_paths/33.png}\hfill
%     \includegraphics[width=.24\textwidth]{Images/simulation_no_obs/straight_paths/34.png}
% \end{figure}
% \begin{figure}
%     \includegraphics[width=.24\textwidth]{Images/simulation_no_obs/straight_paths/41.png}\hfill
%     \includegraphics[width=.24\textwidth]{Images/simulation_no_obs/straight_paths/42.png}\hfill
%     \includegraphics[width=.24\textwidth]{Images/simulation_no_obs/straight_paths/43.png}\hfill
%     \includegraphics[width=.24\textwidth]{Images/simulation_no_obs/straight_paths/44.png}
% \end{figure}

% \begin{figure}
%     \includegraphics[width=.24\textwidth]{Images/simulation_no_obs/straight_paths/51.png}\hfill
%     \includegraphics[width=.24\textwidth]{Images/simulation_no_obs/straight_paths/52.png}\hfill
%     \includegraphics[width=.24\textwidth]{Images/simulation_no_obs/straight_paths/53.png}\hfill
%     \includegraphics[width=.24\textwidth]{Images/simulation_no_obs/straight_paths/54.png}
%     \caption{Write caption explaining images}\label{fig:foobar}
% \end{figure}
...
% \begin{figure}
%     \includegraphics[width=.24\textwidth]{Images/simulation_no_obs/dubins_path/01.png}\hfill
%     \includegraphics[width=.24\textwidth]{Images/simulation_no_obs/dubins_path/02.png}\hfill
%     \includegraphics[width=.24\textwidth]{Images/simulation_no_obs/dubins_path/03.png}\hfill
%     \includegraphics[width=.24\textwidth]{Images/simulation_no_obs/dubins_path/04.png}
%     \\[\smallskipamount]
% \end{figure}

% \begin{figure}
%     \includegraphics[width=.24\textwidth]{Images/simulation_no_obs/dubins_path/11.png}\hfill
%     \includegraphics[width=.24\textwidth]{Images/simulation_no_obs/dubins_path/12.png}\hfill
%     \includegraphics[width=.24\textwidth]{Images/simulation_no_obs/dubins_path/13.png}\hfill
%     \includegraphics[width=.24\textwidth]{Images/simulation_no_obs/dubins_path/14.png}
% \end{figure}
% \begin{figure}
%     \includegraphics[width=.24\textwidth]{Images/simulation_no_obs/dubins_path/21.png}\hfill
%     \includegraphics[width=.24\textwidth]{Images/simulation_no_obs/dubins_path/22.png}\hfill
%     \includegraphics[width=.24\textwidth]{Images/simulation_no_obs/dubins_path/23.png}\hfill
%     \includegraphics[width=.24\textwidth]{Images/simulation_no_obs/dubins_path/24.png}
% \end{figure}
% \begin{figure}  
%     \includegraphics[width=.24\textwidth]{Images/simulation_no_obs/dubins_path/31.png}\hfill
%     \includegraphics[width=.24\textwidth]{Images/simulation_no_obs/dubins_path/32.png}\hfill
%     \includegraphics[width=.24\textwidth]{Images/simulation_no_obs/dubins_path/33.png}\hfill
%     \includegraphics[width=.24\textwidth]{Images/simulation_no_obs/dubins_path/34.png}
% \end{figure}
% \begin{figure}
%     \includegraphics[width=.24\textwidth]{Images/simulation_no_obs/dubins_path/41.png}\hfill
%     \includegraphics[width=.24\textwidth]{Images/simulation_no_obs/dubins_path/42.png}\hfill
%     \includegraphics[width=.24\textwidth]{Images/simulation_no_obs/dubins_path/43.png}\hfill
%     \includegraphics[width=.24\textwidth]{Images/simulation_no_obs/dubins_path/44.png}
% \end{figure}

% \begin{figure}
%     \includegraphics[width=.24\textwidth]{Images/simulation_no_obs/dubins_path/51.png}\hfill
%     \includegraphics[width=.24\textwidth]{Images/simulation_no_obs/dubins_path/52.png}\hfill
%     \includegraphics[width=.24\textwidth]{Images/simulation_no_obs/dubins_path/53.png}\hfill
%     \includegraphics[width=.24\textwidth]{Images/simulation_no_obs/dubins_path/54.png}
%     \caption{Write caption explaining images}\label{fig:foobar}
% \end{figure}
...
% \begin{figure}
%     \includegraphics[width=.24\textwidth]{Images/simulation_no_obs/coverage_plots/01.png}\hfill
%     \includegraphics[width=.24\textwidth]{Images/simulation_no_obs/coverage_plots/02.png}\hfill
%     \includegraphics[width=.24\textwidth]{Images/simulation_no_obs/coverage_plots/03.png}\hfill
%     \includegraphics[width=.24\textwidth]{Images/simulation_no_obs/coverage_plots/04.png}
%     \\[\smallskipamount]
% \end{figure}

% \begin{figure}
%     \includegraphics[width=.24\textwidth]{Images/simulation_no_obs/coverage_plots/11.png}\hfill
%     \includegraphics[width=.24\textwidth]{Images/simulation_no_obs/coverage_plots/12.png}\hfill
%     \includegraphics[width=.24\textwidth]{Images/simulation_no_obs/coverage_plots/13.png}\hfill
%     \includegraphics[width=.24\textwidth]{Images/simulation_no_obs/coverage_plots/14.png}
% \end{figure}
% \begin{figure}
%     \includegraphics[width=.24\textwidth]{Images/simulation_no_obs/coverage_plots/21.png}\hfill
%     \includegraphics[width=.24\textwidth]{Images/simulation_no_obs/coverage_plots/22.png}\hfill
%     \includegraphics[width=.24\textwidth]{Images/simulation_no_obs/coverage_plots/23.png}\hfill
%     \includegraphics[width=.24\textwidth]{Images/simulation_no_obs/coverage_plots/24.png}
% \end{figure} 
% \begin{figure}   
%     \includegraphics[width=.24\textwidth]{Images/simulation_no_obs/coverage_plots/31.png}\hfill
%     \includegraphics[width=.24\textwidth]{Images/simulation_no_obs/coverage_plots/32.png}\hfill
%     \includegraphics[width=.24\textwidth]{Images/simulation_no_obs/coverage_plots/33.png}\hfill
%     \includegraphics[width=.24\textwidth]{Images/simulation_no_obs/coverage_plots/34.png}
% \end{figure} 
% \begin{figure} 
%     \includegraphics[width=.24\textwidth]{Images/simulation_no_obs/coverage_plots/41.png}\hfill
%     \includegraphics[width=.24\textwidth]{Images/simulation_no_obs/coverage_plots/42.png}\hfill
%     \includegraphics[width=.24\textwidth]{Images/simulation_no_obs/coverage_plots/43.png}\hfill
%     \includegraphics[width=.24\textwidth]{Images/simulation_no_obs/coverage_plots/44.png}
% \end{figure} 
 
% \begin{figure}
%     \includegraphics[width=.24\textwidth]{Images/simulation_no_obs/coverage_plots/51.png}\hfill
%     \includegraphics[width=.24\textwidth]{Images/simulation_no_obs/coverage_plots/52.png}\hfill
%     \includegraphics[width=.24\textwidth]{Images/simulation_no_obs/coverage_plots/53.png}\hfill
%     \includegraphics[width=.24\textwidth]{Images/simulation_no_obs/coverage_plots/54.png}
%     \caption{Write caption explaining images}\label{fig:foobar}
% \end{figure}
