...
% \fancyhead[R]{\rightmark\hfill\leftmark}
% \fancyhead[R]{\thepage} % Only show page number

% \fancyhead[R]{\hfill\thepage}
% \fancyhead[R]{\thepage} % Only show page number
\fancyfoot[L]{\rule{\textwidth}{0.4pt}\hspace{1cm} MSc in Intelligent Field Robotic Systems}
...
\include{Elements/Literature_Review/literature_review_obs}
...
% \include{Elements/Methodology/Behavioral_algorithm/Behavioral_algorithm_math}
...
\include{Elements/Bibliography/Bibliography}


\include{Elements/Appendix/Appendix}
